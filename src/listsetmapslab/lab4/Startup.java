...
public class Startup {
    ...
    public static void main(String[] args) {
        ...
        list.add(0, e1);
        System.out.println("Removing dups... after re-adding John");
        
        Set tempSet = new HashSet(list);
        List<Employee> newList = new ArrayList(tempSet);
